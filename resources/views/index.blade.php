        ...
        <div class="prices__inner">
            <div class="prices__row">
                <div class="prices__content" data-aos="slide-left">
                    ...
                    <p class="prices__text">Групповые занятия (8 занятий по 1,5 часа) - 900 грн.
                        </br>При оплате за весь курс (40 занятий) - скидка 15%.
                        </br>Группа выходного дня (4 занятия по 2 часа) - 800 грн.
                ...
                <div class="footer__social">
                    ...
                    <ul class="footer__social-list">
                        <li class="footer__social-item">
                            ...
                            <a href="{{env('FB_LINK')}}" target="_blank" class="footer__social-link">Facebook</a>
                        </li>
                        <li class="footer__social-item">
                            <span class="footer__social-icon inst-icon"></span>
                            <a href="{{env('INST_LINK')}}" target="_blank" class="footer__social-link">Instagram</a>
                        </li>
                    </ul>
                </div>
            </div>
